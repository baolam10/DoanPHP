    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('goi-credit.them-moi') }}" class="btn btn-primary btn-rounded waves-effect waves-light">Thêm Mới</a>
                <br>
                <br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('goi-credit.cap-nhat', ['id' => $goiCredit->id ]) }}" class="btn btn-outline-success btn-rounded waves-effect waves-light">
