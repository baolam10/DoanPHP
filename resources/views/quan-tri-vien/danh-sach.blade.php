    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('quan-tri-vien.them-moi') }}" class="btn btn-primary btn-rounded waves-effect waves-light">Thêm Mới</a>
                <br>
                <br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('quan-tri-vien.cap-nhat', ['id' => $quantrivien->id ]) }}" class="btn btn-outline-success btn-rounded waves-effect waves-light">
