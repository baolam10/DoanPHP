            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ml-1">
                      Đỗ Trần Bảo Lâm<i class="mdi mdi-chevron-down"></i> 
                    </span>
                </a>
            ...
            <ul class="navigation-menu">
                ...
                <li class="has-submenu">
                    <a href="{{ route('trang-chu')}}">
                        <i class="fas fa-address-book"></i>Trang chủ </a>
                </li>

                <li class="has-submenu">
                    <a href="{{ route('quan-tri-vien.danh-sach') }}">
                        <i class="fe-user"></i>Quản Trị Viên <div class="arrow-down"></div></a>
                    <ul class="submenu">
                        <li>
                 ...
                 <li class="has-submenu">
                    <a href="{{ route('nguoi-choi.danh-sach') }}">
                        <i class="fe-user"></i>Người chơi <div class="arrow-down"></div></a>
                    <ul class="submenu">
                        <li>
                ...
                <li class="has-submenu">
                    <a href="{{ route('goi-credit.danh-sach') }}">
                        <i class="fas fa-cart-plus"></i>Gói Credit<div class="arrow-down"></div></a>
                </li>
